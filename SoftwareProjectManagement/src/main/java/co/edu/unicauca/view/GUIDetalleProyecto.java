...
public class GUIDetalleProyecto extends javax.swing.JFrame {
    ...
    public GUIDetalleProyecto(int id,int idUsuario_) {
        initComponents();
        this.idProyecto = id;
    ...
    private void cargarDatosProyecto(int idProyecto) {
        String query = "SELECT nombre, descripcion, fecha FROM proyectos WHERE id = ?";
        ...
        try (Connection conexion = Conectionbd.conectar();
            ...
            if (rs.next()) {
                ...
                txtTiempoMaximo.setText(rs.getString("tiempomaximo"));
                txtPresupuesto.setText(rs.getString("Presupuesto"));
                txtAreaObjetivos.setText(rs.getString("objetivos"));
                txtAreaResumen.setText(rs.getString("Resumen"));
    ...
    private void btnPostularseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPostularseActionPerformed
        String query = "INSERT INTO postulaciones (id_estudiante, id_proyecto) VALUES (?, ?)";

        try (Connection conn = Conectionbd.conectar();
            ...
            JOptionPane.showMessageDialog(this, "Postulación realizada con éxito.");

        } catch (SQLException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error al postularse.");
        }

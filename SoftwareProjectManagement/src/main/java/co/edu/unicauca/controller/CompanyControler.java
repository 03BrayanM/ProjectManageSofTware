 ...
 * @author Brayan
 */
public class CompanyControler implements IGestor {
...
public boolean Registrarusuario(Object usuario) {  
    ...
    try {
        ...
        // Mensaje en la interfaz gráfica
        JOptionPane.showMessageDialog(null, "Empresa registrada exitosamente.", "Registro Exitoso", JOptionPane.INFORMATION_MESSAGE);
